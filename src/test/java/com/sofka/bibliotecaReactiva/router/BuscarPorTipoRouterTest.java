...
@ContextConfiguration(classes= {BuscarPorTipoRouter.class, UseCaseBuscarPorTipo.class, MapperUtils.class})
class BuscarPorTipoRouterTest {
    ...
    public void buscarPorAreaTest(){
        ...
        recurso1.setId("64444");
        recurso1.setTematica(Tematica.CIENCIAS);
